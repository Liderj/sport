<template>
  <div style="margin-bottom:2.44rem">
    ...
    <div class="training_tips">
      ...
      <span slot="title" style="color:#EDA031;font-size:14px">课程开始前24小时可退</span>
    </div>
    ...
    <div class="address">
      <img slot="icon" style=" margin-right:.421875rem;width:.5625rem;height:.6875rem;display:inline-block;vertical-align:middle;"
